...
FILES=./main.o ./src/game_control.o ./src/board.o ./src/tile.o ./src/moves.o ./graphics/render_tile.o ./graphics/render_board.o ./graphics/tile_colors.o ./tests/utils.o
